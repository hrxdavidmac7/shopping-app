...
export function Debouncing()
{
    ...
    return(
        <div className="container">
            ...
            <button onClick={handleShowClick} className="btn btn-success">Show Tips</button>
            <button onClick={handleCancelClick} className="btn btn-warning">Cancel Tip2</button>
            <h3>{msg}</h3>
            </div>
        </div>
    )
